...
import SvgUser from "@/app/assets/svg/user";
import SvgCart from "@/app/assets/svg/cart";
import { signInSignUpModalVisible } from "@/redux/features/global/global-slice";
...
const Header = () => {
  ...
  const handleSignInModal = () => {
    dispatch(signInSignUpModalVisible());
  };
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        {/* <!-- header top start --> */}
        <div
          className={`flex flex-col lg:flex-row gap-10 items-end lg:items-center xl:justify-between ease-out duration-200 ${
            stickyMenu ? "py-4" : "py-6"
          }`}
        >
          {/* <!-- header top left --> */}
          <div className="xl:w-full flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
